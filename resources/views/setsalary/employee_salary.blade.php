                    ...
                    <div class="card set-card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-11">
                                    {{-- <h5>{{ __('Employee Salary') }}</h5> --}}
                                    <h5>{{ __('Advance Salary') }}</h5>

                                </div>
                                {{-- @can('Create Set Salary') --}}
                                    <div class="col-1 text-end">

                                        <a data-url="{{ route('employee.advance.salary', $employee->id) }}" data-ajax-popup="true"
                                            data-title="{{ __('Advance Salary') }}" data-bs-toggle="tooltip" title=""
                                            class="btn btn-sm btn-primary" data-bs-original-title="{{ __('Advance Salary') }}">
                                            <i class="ti ti-plus"></i>
                                        </a>
