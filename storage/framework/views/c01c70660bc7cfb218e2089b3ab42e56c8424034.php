            ...
            <?php if(Gate::check('Manage Set Salary') || Gate::check('Manage Pay Slip')): ?>
                <li
                    ...
                    <ul class="dash-submenu ">
                        ...
                        <li class="dash-item">
                            <a class="dash-link"
                                href="<?php echo e(route('advancesalary.index')); ?>"><?php echo e(__('Advandce Salary Request')); ?></a>
                        </li>
                    </ul>
                </li>
            <?php endif; ?>
...
<?php /**PATH /Users/jeetpandya/Desktop/workspace/MySmartSolution/hrm/resources/views/partial/Admin/menu.blade.php ENDPATH**/ ?>