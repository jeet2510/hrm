<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="<?php echo e(route('tax.index')); ?>"
            class="list-group-item list-group-item-action border-0 <?php echo e(request()->is('tax*') ? 'active' : ''); ?>"><?php echo e(__('Tax')); ?>

            <div class="float-end"><i class="ti ti-chevron-right"></i></div>
        </a>
        <a href="<?php echo e(route('slab.index')); ?>"
            class="list-group-item list-group-item-action border-0 <?php echo e(request()->is('slab*') ? 'active' : ''); ?>"><?php echo e(__('Tax Slab')); ?>
...
<?php /**PATH /Users/jeetpandya/Desktop/workspace/MySmartSolution/hrm/resources/views/layouts/hrm_setup.blade.php ENDPATH**/ ?>