                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-md">
                                    <tbody>
                                        ...
                                        <?php if($payslipDetail['taxDeduction']['final_tax'] > 0): ?>
                                            <tr>
                                                <td><?php echo e(__('Tax Deduction')); ?></td>
                                                <td><?php echo e($payslipDetail['taxDeduction']['tax_title']); ?></td>
                                                
                                                <td> - </td>
                                                <td class="text-right">
                                                    <?php echo e(\Auth::user()->priceFormat($payslipDetail['taxDeduction']['final_tax'] ?? 0)); ?>
...
<?php /**PATH /Users/jeetpandya/Desktop/workspace/MySmartSolution/hrm/resources/views/payslip/pdf.blade.php ENDPATH**/ ?>