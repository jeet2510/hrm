                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-11">
                                    ...
                                    <h5><?php echo e(__('Advance Salary')); ?></h5>

                                </div>
                                
                                    <div class="col-1 text-end">

                                        <a data-url="<?php echo e(route('employee.advance.salary', $employee->id)); ?>" data-ajax-popup="true"
                                            data-title="<?php echo e(__('Advance Salary')); ?>" data-bs-toggle="tooltip" title=""
                                            class="btn btn-sm btn-primary" data-bs-original-title="<?php echo e(__('Advance Salary')); ?>">
                                            <i class="ti ti-plus"></i>
                                        </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/jeetpandya/Desktop/workspace/MySmartSolution/hrm/resources/views/setsalary/employee_salary.blade.php ENDPATH**/ ?>