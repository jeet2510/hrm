...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::get('employee/advance/salary/{eid}', [SetSalaryController::class, 'employeeAdvanceSalary'])->name('employee.advance.salary')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::resource('advancesalary', AdvanceSalaryController::class)->except([
        'show'
    ]);
    ...
    Route::resource('slab', TaxSlabController::class)->middleware(
        [
            'auth',
            'XSS',
        ]
